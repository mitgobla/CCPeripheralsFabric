...
public class BlockEnvironmentSensor extends FacingBlock implements BlockEntityProvider {

    public BlockEnvironmentSensor(AbstractBlock.Settings settings) {
        super(settings);
    ...
    public BlockEntity createBlockEntity(BlockView world) {
        return new TileEnvironmentSensor();
    }
}
